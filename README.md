...
- 🔍 Interested in Data Science, AI/ML, NLP, Generative AI, and LLM-based systems

- 🏗️ Love building end-to-end projects (backend, models, deployment)

- 📊 Comfortable with data analysis, ML modeling, and Statistical concepts
